...
//  Module 3-3: desk plane + mug geometry | Module 4-3: scene base for camera navigation.
//  Module 5-3: LoadSceneTextures + textured mug rendering.
//  Module 6-3: Milestone Five — Phong materials, scene lights, lit textured rendering.
//  Module 7-1: Final Project — Image 5 desk (monitor, keyboard, mug, books, pencil cup).
///////////////////////////////////////////////////////////////////////////////
...
public:
	...
	// Module 3-3 helpers — I split these out so PrepareScene/RenderScene stay readable.
	void DefineObjectMaterials();
	void SetupSceneLights();
	void RenderDeskSurface();
	void RenderMonitor();
	void RenderDeskProps();
	void RenderDeskMug();

	// Module 5-3 — load JPG/PNG textures from disk into OpenGL slots
