...
// Module 5-3: MSAA + clear color; mug textures applied in SceneManager.cpp.
// Module 6-3: Milestone Five — lighting configured in SceneManager.cpp.
// Module 7-1: Final Project — flat-lay desk scene with full prop layout.
...
int main(int argc, char* argv[])
{
	...
	while (!glfwWindowShouldClose(g_Window))
	{
		...
		// Soft grey fallback — avoids competing with the lit desk when props move.
		glClearColor(0.72f, 0.70f, 0.67f, 1.0f);
...
bool InitializeGLFW()
{
	...
	// 4x MSAA — smooths the tapered cylinder and torus edges a little (same idea as my 3-2 scene).
...
bool InitializeGLEW()
{
	...
	// Turn on multisampling after GLEW init — pairs with the GLFW_SAMPLES hint above.
